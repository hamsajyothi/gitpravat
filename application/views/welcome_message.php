...
<body>
	...
	<div class="container  text-center">
			<div class="agileinfo-logo">
					<h1><a href="<?php echo base_url(); ?>"><span class="fa fa-diamond" aria-hidden="true"></span> Your Url Shortener</a></h1>
			</div>	
			<h2 class="txt-w3_agile">Shorten Url</h2>
